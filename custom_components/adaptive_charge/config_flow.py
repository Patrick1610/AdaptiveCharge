        ...
        schema = vol.Schema(
            {
                ...
                vol.Optional(CONF_LOW_POWER_THRESHOLD, default=DEFAULT_LOW_POWER_THRESHOLD): selector.selector(
                    {
                        "number": {
                            "min": 0,
                            "max": 100,
                ...
                vol.Optional(CONF_LOW_POWER_FORECAST_KWH, default=DEFAULT_LOW_POWER_FORECAST_KWH): selector.selector(
                    {
                        "number": {
                            "min": 0,
                            "max": 50,
        ...
        schema = vol.Schema(
            {
                ...
                vol.Optional(
                    CONF_LOW_POWER_THRESHOLD,
                    default=int(current.get(CONF_LOW_POWER_THRESHOLD, DEFAULT_LOW_POWER_THRESHOLD)),
                ): selector.selector(
                    {"number": {"min": 0, "max": 100, "step": 5, "unit_of_measurement": "%", "mode": "box"}}
                ),
                vol.Optional(
                    CONF_LOW_POWER_FORECAST_KWH,
                    default=float(current.get(CONF_LOW_POWER_FORECAST_KWH, DEFAULT_LOW_POWER_FORECAST_KWH)),
                ): selector.selector(
